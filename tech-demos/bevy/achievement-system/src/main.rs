//! Achievement system — progress-tracked milestones with unlock toasts.
//!
//! Key ideas:
...
impl Achievement {
    fn new(name: &'static str, goal: u32) -> Self {
...
#[derive(Resource)]
struct AchievementRegistry(Vec<Achievement>);
