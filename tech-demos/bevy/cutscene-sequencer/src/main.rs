//! # Cutscene Sequencer
//!
//! A data-driven cutscene system in which a `Vec<CutsceneStep>` drives itself
//! forward using elapsed time tracked in a `Cutscene` resource.  No coroutines
//! or async — pure ECS state machine.
//!
...
fn main() {
    App::new()
        ...
        .insert_resource(Cutscene::default_sequence())
