//! # Observer Events Demo
//!
//! Side-by-side comparison of Bevy's two event delivery systems in Bevy 0.18:
//!
...
//!
//! A hit counter and flash effect (red for 0.3 s) illustrate both paths in action.
...
fn update_visuals(
    ...
    for (ht, mut sprite, kind) in &mut targets {
        ...
        let [r, g, b] = flash_color(elapsed, FLASH_DURATION, BASE_COLOR, FLASH_COLOR);
